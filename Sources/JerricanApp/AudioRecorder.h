...
// that read. Same justified-exception shape as other single-swap locks
// already in this codebase (e.g. MidiBindingManager's mutex) — held
// briefly, essentially always uncontended, once per audio block rather
// than per sample.
class AudioRecorder {
public:

...
public:
    HelpContent() {
        ...
        const juce::String bodyText =
            ...
            "button next to Enabled; while any voice is soloed, only "
            "soloed voices are audible (others keep running underneath, "
            "just silently). Volume - overall level. Pitch Range - band "
            "this voice's pitches are drawn from. Dissonance - 0 quantizes "
            "to this voice's scale so it harmonizes with others; 1 is "
            "fully free/chromatic. Key - which note that scale is rooted "
            "on; give two voices different Keys (e.g. a fifth apart) to "
            "build a deliberate chord at low Dissonance instead of unison. "
            "Key is never affected by Evolution or Randomize.\n\n"
            "BASS\n"
            ...
            "busy.\n"
            "Wander - harmonic movement: how far the line roams from a "
            "steady center pitch through the scale; 0 keeps it close to "
            "that center, higher values let it range further.\n"
            ...
            "sparse tone to a dense overlapping wash. Very unlikely to go "
            "fully silent even at 0 - a density floor keeps new layers "
            "spawning only rarely rather than stopping outright.\n"
            ...
            "0 is untouched, 1 ramps to a thick, heavily saturated "
            "character built from several detuned voices clipped "
            "together, not just one oscillator driven harder.\n"
